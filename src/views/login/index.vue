      ...
      <div class="form-container">
        ...
        <div class="form-content">
          <el-form>
            ...
            <el-form-item>
              <el-input v-model="formData.password" :prefix-icon="Message" type="password" placeholder="请输入密码"
                show-password>

              </el-input>
            </el-form-item>
            <el-form-item clas="capche-img">
              <el-input v-model="formData.code" style="width:216px;margin-right:10px" placeholder="请输入验证码">
