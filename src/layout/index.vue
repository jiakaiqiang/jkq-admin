  ...
  <section style="display: flex;min-width: 1200px">
    ...
    <main>
      ...
      <div class="container" id="container" v-if="systemStore.isRefresh">
        ...
        <div v-if="systemStore.isShowICP"
          style="height:50px;background: var(--el-bg-color-page);text-align: center;padding-top: 20px;margin-top:10px;line-height: 20px;margin-bottom:10px">
          备案号:陕ICP备2024040409号-1</div>
